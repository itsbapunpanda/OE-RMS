...
<body>
 ...
 <nav class="navbar navbar-dark fixed-top bg-info flex-md-nowrap p-0 shadow">
   <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="RequesterProfile.php">OE-RMS</a>
   <span class="navbar-text mr-5 ">Customer's Happiness is our Aim</span>
 </nav>

 <!-- Side Bar -->
 <div class="container-fluid mb-5 " style="margin-top:40px;">
  <div class="row">
   <nav class="col-sm-2 bg-info sidebar py-5 d-print-none"> <!-- Start Side Bar 1st Column -->
